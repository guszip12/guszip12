            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="<?php echo e(route('admin.dokumentasi.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php /**PATH D:\laravel-11-multi-auth-main\resources\views/admin/layouts/create.blade.php ENDPATH**/ ?>