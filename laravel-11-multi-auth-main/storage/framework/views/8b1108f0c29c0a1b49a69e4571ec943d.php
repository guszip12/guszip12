            ...
            <div id="printableArea" class="card mb-4 shadow-sm">
                <div class="row g-0">
                    <div class="col-md-4 d-flex justify-content-center align-items-center">
                        <img src="<?php echo e(asset($submittedData['foto'])); ?>" alt="Foto" class="img-fluid custom-img">
                    </div>
                    <div class="col-md-8">
                            ...
                            <table class="table table-striped">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?php echo e($submittedData['nomor_registrasi']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>No. KTP</th>
                                        <td><?php echo e($submittedData['ktp']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Nama</th>
                                    ...
                                    <tr>
                                        <th>Alamat</th>
                                        <td><?php echo e($submittedData['alamat']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>HP</th>
                                        <td><?php echo e($submittedData['hp']); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Email</th>
                                    ...
                                    <tr>
                                        <th>Asal Sekolah</th>
                                        <td><?php echo e($submittedData['school_name']); ?></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<?php /**PATH D:\laravel-11-multi-auth-main\resources\views\layouts\summary.blade.php ENDPATH**/ ?>