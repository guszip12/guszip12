                        ...
                        <?php $__currentLoopData = $dokumentasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($doc->jenis == 'Persentasi PKL'): ?>
                                <tr>
                                    ...
                                    <td>
                                        <form action="<?php echo e(route('admin.dokumentasi.delete', $doc->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $dokumentasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($doc->jenis == 'Kegiatan PKL'): ?>
                                <tr>
                                    ...
                                    <td><?php echo e($doc->jenis); ?></td>
                                    <td>
                                        <form action="<?php echo e(route('admin.dokumentasi.delete', ['id' => $doc->id])); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('DELETE'); ?>
...
<?php /**PATH D:\laravel-11-multi-auth-main\resources\views/admin/layouts/index.blade.php ENDPATH**/ ?>