        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $bidangCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $bidang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($index + 1); ?></td>
                                        <td><?php echo e($bidang->bidang); ?></td>
                                        <td><?php echo e($bidang->jumlah); ?></td>
                                    </tr>
                ...
                <div class="col-md-12 text-end">
                    <a href="<?php echo e(route('dokumentasi.index')); ?>" class="btn btn-primary mt-3">Selengkapnya</a>
                </div>
