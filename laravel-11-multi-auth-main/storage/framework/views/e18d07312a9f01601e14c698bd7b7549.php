            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body card-body-custom">
                        <form action="<?php echo e(route('update-mahasiswa', ['id' => $mahasiswa->id])); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\laravel-11-multi-auth-main\resources\views\layouts\edit-mahasiswa.blade.php ENDPATH**/ ?>