...
<body>
    <div class="container">
        ...
        <form action="<?php echo e(route('admin.update-presentasi', ['id' => $user->id])); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name_pembina" name="name_pembina" value="<?php echo e($user->name_pembina); ?>" required>
            </div>

            <div class="mb-3">
                <label for="name_seksi">Nama Seksi:</label>
                <input type="text" class="form-control" id="name_seksi" name="name_seksi" value="<?php echo e($user->name_seksi); ?>" required>
            </div>
...
<?php /**PATH D:\laravel-11-multi-auth-main\resources\views/admin/layouts/edit-presentasi.blade.php ENDPATH**/ ?>